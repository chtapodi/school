 ...
 * 
 * This is the only class where I'll let you use public instance variables. It's
 * so we can reference information in the nodes using cascading dot notation,
 * like N.next.data instead of N.getNext().getData()
 * 
